...
function GoogleIcon() {
  return (
    <svg width="16" height="16" viewBox="0 0 24 24" aria-hidden="true">
      <path
        d="M21.6 12.23c0-.78-.07-1.53-.2-2.25H12v4.26h5.4a4.62 4.62 0 0 1-2 3.03v2.5h3.24c1.9-1.75 3-4.33 3-7.54z"
        fill="#4285F4"
      />
      <path
        d="M12 22c2.7 0 4.97-.9 6.62-2.43l-3.23-2.5c-.9.6-2.04.96-3.4.96-2.61 0-4.82-1.76-5.61-4.13H3.04v2.59A10 10 0 0 0 12 22z"
        fill="#34A853"
      />
      <path
        d="M6.39 13.9A6 6 0 0 1 6.07 12c0-.66.12-1.3.32-1.9V7.51H3.04A10 10 0 0 0 2 12c0 1.61.39 3.14 1.04 4.49l3.35-2.59z"
        fill="#FBBC05"
      />
      <path
        d="M12 6.04c1.47 0 2.79.5 3.83 1.5l2.87-2.87C16.97 3.1 14.7 2.2 12 2.2A10 10 0 0 0 3.04 7.51l3.35 2.59C7.18 7.8 9.39 6.04 12 6.04z"
        fill="#EA4335"
      />
    </svg>
  );
